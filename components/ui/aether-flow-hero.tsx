...
const AetherFlowHero = () => {
    ...
    return (
        <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
            ...
            <canvas ref={canvasRef} className="absolute top-0 left-0 w-full h-full z-0 block"></canvas>
            
            {/* Overlay HTML Content */}
            <div className="relative z-10 text-center p-6 select-none pointer-events-auto">
                <motion.div
                    custom={0}
